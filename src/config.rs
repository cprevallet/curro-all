...
pub const ICON_NAME: &str = "curro-all";
pub const APP_ID: &str = "com.github.cprevallet.curro-all";
pub const PROGRAM_NAME: &str = "Curro-All";
...
pub const SETTINGSFILE: &str = "curro-all.toml";
